...
public class NLPAssignmentFinal {
	...
	public static void main(String args[]){
		...
		String typeGeneral = "testData/generalUniBiTri";
		 ...
		 */
		testForNGrams(typeGeneral, 1);
		
		/*
		 * Use this function for testing purpose
		 */
		testForNGramsSeparate(typeGeneral+File.separator+1+File.separator+"TESTDIRECTORY/TRAIN",typeGeneral+File.separator+"testFiles/TESTDIRECTORY/TEST",2);
	}
	 ...
	 * @param gram
	 */
	public static void testForNGramsSeparate(String trainDir,String testDir,int gram){
		
			makeDataSet(trainDir,testDir,gram);
	}
	...
	public static void testForNGrams(String type,int gram){
		for(int i = 1;i<6;i++){
			makeDataSet(type+File.separator+i+File.separator+"TESTDIRECTORY/TRAIN",type+File.separator+i+File.separator+"TESTDIRECTORY/TEST",gram);
		}
	}
